...
class GdmaDma : public PlatformDma {
 ...
 private:
  ...
  // --- frame synchronisation ---
    ...
    // GDMA trans-EOF ISR callback. Fires once per descriptor-chain traversal
    // (the last descriptor carries suc_eof = 1).
    static bool frame_eof_isr(gdma_channel_handle_t chan,
